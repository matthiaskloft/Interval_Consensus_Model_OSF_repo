...
Resummarizing results with updated summary function:

```{r}
sim_res_resum <- SimDesign::reSummarise(summarise = sim_summarize,
                                        dir = here("sim_results_itm_2024-09-07_07-27-33/full_sim_results_itm"))
saveRDS(sim_res_resum, file = here("sim_results/sim_res_v2.RDS"))
```
